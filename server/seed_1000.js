...
const LISTING_CATEGORIES = [
  ...
  },
  {
    ...
    titles: [
      "React & JavaScript Mentoring",
      "Python for Beginners",
      "Data Structures Coaching",
      "Debugging & Code Review",
      "Full-Stack Project Help",
    ],
    rate: [30, 90],
  },
  {
...
const TASK_TEMPLATES = [
  ...
  {
    title: "Need a photographer for a birthday party",
    location: "Back Bay, Boston",
    budget: [80, 300],
  },
  {
    title: "Looking for a calculus tutor before finals",
    location: "Snell Library",
    budget: [30, 90],
  },
  {
    title: "Assemble an IKEA desk and shelf",
    location: "Fenway, Boston",
    budget: [25, 70],
  },
  {
    title: "Proofread my grad school essay",
    location: "Remote",
    budget: [20, 80],
  },
  {
    title: "Fix a bug in my React project",
    location: "Remote",
    budget: [40, 150],
  },
  {
  ...
  {
    title: "Deep clean my apartment before move-out",
    location: "Allston, Boston",
    budget: [60, 160],
  },
  {
    title: "Guitar lessons for a beginner",
    location: "Cambridge, MA",
    budget: [25, 75],
  },
  {
    title: "Ride to Logan Airport early morning",
    location: "Roxbury, Boston",
    budget: [20, 60],
  },
  {
    title: "Record and edit a short promo video",
